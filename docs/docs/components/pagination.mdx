...
- [DataTable](/components/data-table) - For displaying paginated data
- [SearchBar](/components/search-bar) - For filtering data before pagination
- [Button](/components/button) - For navigation controls
