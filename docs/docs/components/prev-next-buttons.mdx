...
title: Prev Next Buttons Component (MIS)
sidebar_label: <PrevNextButtons> (MIS)
description: Prev Next Buttons component - Missing implementation
keywords: [prev-next-buttons, missing, todo]
---
...
This component corresponds to the **&lt;PrevNextButtons&gt;** component in React Admin.
