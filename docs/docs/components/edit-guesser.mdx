---
id: edit-guesser
title: Edit Guesser Component (MIS)
sidebar_label: <EditGuesser> (MIS)
description: Edit Guesser component - Missing implementation
keywords: [edit-guesser, missing, todo]
---

# Edit Guesser Component
...
This component corresponds to the **&lt;EditGuesser&gt;** component in React Admin.
