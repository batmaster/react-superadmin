---
id: scheduler
title: Scheduler Component (MIS)
sidebar_label: <Scheduler> (MIS)
description: Scheduler component - Missing implementation
keywords: [scheduler, missing, todo]
---
...
This component corresponds to the **&lt;Scheduler&gt;** component in React Admin.
