---
id: container-layout
title: Container Layout Component (MIS)
sidebar_label: <ContainerLayout> (MIS)
description: Container Layout component - Missing implementation
keywords: [container-layout, missing, todo]
---
...
This component corresponds to the **&lt;ContainerLayout&gt;** component in React Admin.
