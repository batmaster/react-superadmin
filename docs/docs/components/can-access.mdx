---
id: can-access
title: Can Access (MIS)
sidebar_label: <CanAccess> (MIS)
description: Can Access component - Missing implementation
keywords: [can-access, missing, todo]
---
...
This component corresponds to the **&lt;CanAccess&gt;** component in React Admin.
