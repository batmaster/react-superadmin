---
id: tree-with-details
title: Tree With Details Component (MIS)
sidebar_label: <TreeWithDetails> (MIS)
description: Tree With Details component - Missing implementation
keywords: [tree-with-details, missing, todo]
---

# Tree With Details Component
...
This component corresponds to the **&lt;TreeWithDetails&gt;** component in React Admin.
