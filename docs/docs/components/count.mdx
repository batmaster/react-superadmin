---
id: count
title: Count Component (MIS)
sidebar_label: <Count> (MIS)
description: Count component - Missing implementation
keywords: [count, missing, todo]
---
...
This component corresponds to the **&lt;Count&gt;** component in React Admin.
