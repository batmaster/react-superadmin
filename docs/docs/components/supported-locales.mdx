...
title: Supported Locales (MIS)
sidebar_label: <SupportedLocales> (MIS)
description: Supported Locales component - Missing implementation
keywords: [supported-locales, missing, todo]
---

# Supported Locales Component
...
This component corresponds to the **&lt;SupportedLocales&gt;** component in React Admin.
