...
id: auto-save
title: Auto Save (MIS)
sidebar_label: <AutoSave> (MIS)
description: Auto Save component - Missing implementation
keywords: [auto-save, missing, todo]
---
...
This component corresponds to the **&lt;AutoSave&gt;** component in React Admin.
