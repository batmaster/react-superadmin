---
id: text-array-input
title: Text Array Input Component (MIS)
sidebar_label: <TextArrayInput> (MIS)
description: Text Array Input component - Missing implementation
keywords: [text-array-input, missing, todo]
---
...
This component corresponds to the **&lt;TextArrayInput&gt;** component in React Admin.
