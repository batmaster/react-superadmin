---
id: revisions-button
title: Revisions Button Component (MIS)
sidebar_label: <RevisionsButton> (MIS)
description: Revisions Button component - Missing implementation
keywords: [revisions-button, missing, todo]
---

# Revisions Button Component
...
This component corresponds to the **&lt;RevisionsButton&gt;** component in React Admin.
