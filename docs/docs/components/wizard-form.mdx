---
id: wizard-form
title: Wizard Form Component (MIS)
sidebar_label: <WizardForm> (MIS)
description: Wizard Form component - Missing implementation
keywords: [wizard-form, missing, todo]
---
...
This component corresponds to the **&lt;WizardForm&gt;** component in React Admin.
