...
title: Filter Live Search Component (MIS)
sidebar_label: <FilterLiveSearch> (MIS)
description: Filter Live Search component - Missing implementation
keywords: [filter-live-search, missing, todo]
---

# Filter Live Search Component
...
This component corresponds to the **&lt;FilterLiveSearch&gt;** component in React Admin.
