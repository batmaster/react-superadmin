---
id: date-range-input
title: Date Range Input Component (MIS)
sidebar_label: <DateRangeInput> (MIS)
description: Date Range Input component - Missing implementation
keywords: [date-range-input, missing, todo]
---
...
This component corresponds to the **&lt;DateRangeInput&gt;** component in React Admin.
