...
title: Auth Provider Setup (MIS)
sidebar_label: <AuthProviderSetup> (MIS)
description: Auth Provider Setup component - Missing implementation
keywords: [auth-provider-setup, missing, todo]
---

# Auth Provider Setup Component
...
This component corresponds to the **&lt;AuthProviderSetup&gt;** component in React Admin.
