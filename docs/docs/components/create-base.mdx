---
id: create-base
title: Create Base Component (MIS)
sidebar_label: <CreateBase> (MIS)
description: Create Base component - Missing implementation
keywords: [create-base, missing, todo]
---
...
This component corresponds to the **&lt;CreateBase&gt;** component in React Admin.
