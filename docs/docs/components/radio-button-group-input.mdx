---
id: radio-button-group-input
title: Radio Button Group Input Component (MIS)
sidebar_label: <RadioButtonGroupInput> (IMP)
description: Radio Button Group Input component - Missing implementation
keywords: [radio-button-group-input, missing, todo]
---
...
This component corresponds to the **&lt;RadioButtonGroupInput&gt;** component in React Admin.
