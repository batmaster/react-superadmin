---
id: icon-menu
title: Icon Menu Component (MIS)
sidebar_label: <IconMenu> (MIS)
description: Icon Menu component - Missing implementation
keywords: [icon-menu, missing, todo]
---
...
This component corresponds to the **&lt;IconMenu&gt;** component in React Admin.
