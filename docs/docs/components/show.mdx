---
id: show
title: Show Component (MIS)
sidebar_label: <Show> (MIS)
description: Show component - Missing implementation
keywords: [show, missing, todo]
---
...
This component corresponds to the **&lt;Show&gt;** component in React Admin.
