---
id: edit-base
title: Edit Base Component (MIS)
sidebar_label: <EditBase> (MIS)
description: Edit Base component - Missing implementation
keywords: [edit-base, missing, todo]
---
...
This component corresponds to the **&lt;EditBase&gt;** component in React Admin.
