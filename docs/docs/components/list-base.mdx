...
id: list-base
title: List Base (MIS)
sidebar_label: <ListBase> (MIS)
description: List Base component - Missing implementation
keywords: [list-base, missing, todo]
---
...
This component corresponds to the **&lt;ListBase&gt;** component in React Admin.
