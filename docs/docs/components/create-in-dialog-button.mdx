---
id: create-in-dialog-button
title: Create In Dialog Button Component (MIS)
sidebar_label: <CreateInDialogButton> (MIS)
description: Create In Dialog Button component - Missing implementation
keywords: [create-in-dialog-button, missing, todo]
---

# Create In Dialog Button Component
...
This component corresponds to the **&lt;CreateInDialogButton&gt;** component in React Admin.
