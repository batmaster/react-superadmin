---
id: tabbed-show-layout
title: Tabbed Show Layout Component (MIS)
sidebar_label: <TabbedShowLayout> (MIS)
description: Tabbed Show Layout component - Missing implementation
keywords: [tabbed-show-layout, missing, todo]
---

# Tabbed Show Layout Component
...
This component corresponds to the **&lt;TabbedShowLayout&gt;** component in React Admin.
