---
id: configurable
title: Configurable Component (MIS)
sidebar_label: <Configurable> (MIS)
description: Configurable component - Missing implementation
keywords: [configurable, missing, todo]
---
...
This component corresponds to the **&lt;Configurable&gt;** component in React Admin.
