---
id: simple-list
title: Simple List Component (MIS)
sidebar_label: <SimpleList> (MIS)
description: Simple List component - Missing implementation
keywords: [simple-list, missing, todo]
---
...
This component corresponds to the **&lt;SimpleList&gt;** component in React Admin.
