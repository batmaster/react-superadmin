---
id: reference-one-input
title: Reference One Input Component (MIS)
sidebar_label: <ReferenceOneInput> (MIS)
description: Reference One Input component - Missing implementation
keywords: [reference-one-input, missing, todo]
---

# Reference One Input Component
...
This component corresponds to the **&lt;ReferenceOneInput&gt;** component in React Admin.
