...
id: rbac
title: Rbac (MIS)
sidebar_label: <Rbac> (MIS)
description: Rbac component - Missing implementation
keywords: [rbac, missing, todo]
---
...
This component corresponds to the **&lt;Rbac&gt;** component in React Admin.
