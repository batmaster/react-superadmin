...
title: Toggle Theme Button Component (MIS)
sidebar_label: <ToggleThemeButton> (MIS)
description: Toggle Theme Button component - Missing implementation
keywords: [toggle-theme-button, missing, todo]
---
...
This component corresponds to the **&lt;ToggleThemeButton&gt;** component in React Admin.
