---
id: check-for-application-update
title: Check For Application Update Component (MIS)
sidebar_label: <CheckForApplicationUpdate> (MIS)
description: Check For Application Update component - Missing implementation
keywords: [check-for-application-update, missing, todo]
---

# Check For Application Update Component
...
This component corresponds to the **&lt;CheckForApplicationUpdate&gt;** component in React Admin.
