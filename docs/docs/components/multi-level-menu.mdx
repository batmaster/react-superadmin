---
id: multi-level-menu
title: Multi Level Menu Component (MIS)
sidebar_label: <MultiLevelMenu> (MIS)
description: Multi Level Menu component - Missing implementation
keywords: [multi-level-menu, missing, todo]
---
...
This component corresponds to the **&lt;MultiLevelMenu&gt;** component in React Admin.
