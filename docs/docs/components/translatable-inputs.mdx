---
id: translatable-inputs
title: Translatable Inputs Component (MIS)
sidebar_label: <TranslatableInputs> (MIS)
description: Translatable Inputs component - Missing implementation
keywords: [translatable-inputs, missing, todo]
---

# Translatable Inputs Component
...
This component corresponds to the **&lt;TranslatableInputs&gt;** component in React Admin.
