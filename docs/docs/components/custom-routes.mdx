---
id: custom-routes
title: Custom Routes Component (MIS)
sidebar_label: <CustomRoutes> (MIS)
description: Custom Routes component - Missing implementation
keywords: [custom-routes, missing, todo]
---
...
This component corresponds to the **&lt;CustomRoutes&gt;** component in React Admin.
