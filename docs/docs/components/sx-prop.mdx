...
id: sx-prop
title: Sx Prop (MIS)
sidebar_label: <SxProp> (MIS)
description: Sx Prop component - Missing implementation
keywords: [sx-prop, missing, todo]
---
...
This component corresponds to the **&lt;SxProp&gt;** component in React Admin.
