---
id: authenticated
title: Authenticated (MIS)
sidebar_label: <Authenticated> (MIS)
description: Authenticated component - Missing implementation
keywords: [authenticated, missing, todo]
---
...
This component corresponds to the **&lt;Authenticated&gt;** component in React Admin.
