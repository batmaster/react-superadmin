---
id: file-field
title: File Field Component (MIS)
sidebar_label: <FileField> (MIS)
description: File Field component - Missing implementation
keywords: [file-field, missing, todo]
---
...
This component corresponds to the **&lt;FileField&gt;** component in React Admin.
