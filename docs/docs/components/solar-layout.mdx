---
id: solar-layout
title: Solar Layout Component (MIS)
sidebar_label: <SolarLayout> (MIS)
description: Solar Layout component - Missing implementation
keywords: [solar-layout, missing, todo]
---
...
This component corresponds to the **&lt;SolarLayout&gt;** component in React Admin.
