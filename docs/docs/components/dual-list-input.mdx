---
id: dual-list-input
title: Dual List Input Component (MIS)
sidebar_label: <DualListInput> (MIS)
description: Dual List Input component - Missing implementation
keywords: [dual-list-input, missing, todo]
---

# Dual List Input Component
...
This component corresponds to the **&lt;DualListInput&gt;** component in React Admin.
