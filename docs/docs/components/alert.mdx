...
```tsx
<Alert variant='success' className='my-4 border-l-4 border-green-500'>
...
- [Button](/components/button) - For action buttons within alerts
- [Badge](/components/badge) - For status indicators
- [Modal](/components/modal) - For more detailed information dialogs
