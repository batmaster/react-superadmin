...
title: Supported Backends (MIS)
sidebar_label: <SupportedBackends> (MIS)
description: Supported Backends component - Missing implementation
keywords: [supported-backends, missing, todo]
---

# Supported Backends Component
...
This component corresponds to the **&lt;SupportedBackends&gt;** component in React Admin.
