---
id: show-in-dialog-button
title: Show In Dialog Button Component (MIS)
sidebar_label: <ShowInDialogButton> (MIS)
description: Show In Dialog Button component - Missing implementation
keywords: [show-in-dialog-button, missing, todo]
---

# Show In Dialog Button Component
...
This component corresponds to the **&lt;ShowInDialogButton&gt;** component in React Admin.
