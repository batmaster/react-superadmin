---
id: sort-button
title: Sort Button Component (MIS)
sidebar_label: <SortButton> (MIS)
description: Sort Button component - Missing implementation
keywords: [sort-button, missing, todo]
---
...
This component corresponds to the **&lt;SortButton&gt;** component in React Admin.
