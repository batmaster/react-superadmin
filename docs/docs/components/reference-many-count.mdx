---
id: reference-many-count
title: Reference Many Count Component (MIS)
sidebar_label: <ReferenceManyCount> (MIS)
description: Reference Many Count component - Missing implementation
keywords: [reference-many-count, missing, todo]
---

# Reference Many Count Component
...
This component corresponds to the **&lt;ReferenceManyCount&gt;** component in React Admin.
