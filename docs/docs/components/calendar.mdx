---
id: calendar
title: Calendar Component (MIS)
sidebar_label: <Calendar> (MIS)
description: Calendar component - Missing implementation
keywords: [calendar, missing, todo]
---
...
This component corresponds to the **&lt;Calendar&gt;** component in React Admin.
