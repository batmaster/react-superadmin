---
id: save-button
title: Save Button (MIS)
sidebar_label: <SaveButton> (MIS)
description: Save Button component - Missing implementation
keywords: [save-button, missing, todo]
---
...
This component corresponds to the **&lt;SaveButton&gt;** component in React Admin.
