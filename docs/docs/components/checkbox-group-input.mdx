...
sidebar_label: <CheckboxGroupInput> (IMP)
  ...
  return (
    <form className='space-y-6'>
      <CheckboxGroupInput
        ...
        onChange={values =>
          setPreferences(prev => ({ ...prev, notifications: values }))
        }
      ...
      <CheckboxGroupInput
        ...
        onChange={values =>
          setPreferences(prev => ({ ...prev, privacy: values }))
        }
      ...
      <CheckboxGroupInput
        ...
        onChange={values =>
          setPreferences(prev => ({ ...prev, features: values }))
        }
...
- [CheckboxInput](/components/checkbox-input) - For single checkbox selection
- [BooleanInput](/components/boolean-input) - For boolean input with radio buttons
- [SelectInput](/components/select-input) - For dropdown selection
- [Form](/components/form) - For form containers and validation
