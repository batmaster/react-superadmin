---
id: show-dialog
title: Show Dialog Component (MIS)
sidebar_label: <ShowDialog> (MIS)
description: Show Dialog component - Missing implementation
keywords: [show-dialog, missing, todo]
---
...
This component corresponds to the **&lt;ShowDialog&gt;** component in React Admin.
