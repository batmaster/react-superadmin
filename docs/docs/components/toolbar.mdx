...
id: toolbar
title: Toolbar (MIS)
sidebar_label: <Toolbar> (MIS)
description: Toolbar component - Missing implementation
keywords: [toolbar, missing, todo]
---
...
This component corresponds to the **&lt;Toolbar&gt;** component in React Admin.
