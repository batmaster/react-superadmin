---
id: fetch-json
title: Fetch Json (MIS)
sidebar_label: <FetchJson> (MIS)
description: Fetch Json component - Missing implementation
keywords: [fetch-json, missing, todo]
---
...
This component corresponds to the **&lt;FetchJson&gt;** component in React Admin.
