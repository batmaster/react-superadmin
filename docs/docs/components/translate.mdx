---
id: translate
title: Translate Component (MIS)
sidebar_label: <Translate> (MIS)
description: Translate component - Missing implementation
keywords: [translate, missing, todo]
---
...
This component corresponds to the **&lt;Translate&gt;** component in React Admin.
