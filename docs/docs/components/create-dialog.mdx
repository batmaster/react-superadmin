---
id: create-dialog
title: Create Dialog Component (MIS)
sidebar_label: <CreateDialog> (MIS)
description: Create Dialog component - Missing implementation
keywords: [create-dialog, missing, todo]
---
...
This component corresponds to the **&lt;CreateDialog&gt;** component in React Admin.
