...
sidebar_label: <ResourceList> (IMP)
...
- [DataTable](/components/data-table) - For displaying list data
- [Pagination](/components/pagination) - For page navigation
- [SearchBar](/components/search-bar) - For list filtering
- [Button](/components/button) - For list actions
- [Form](/components/form) - For filter forms
