---
id: list-live-update
title: List Live Update Component (MIS)
sidebar_label: <ListLiveUpdate> (MIS)
description: List Live Update component - Missing implementation
keywords: [list-live-update, missing, todo]
---

# List Live Update Component
...
This component corresponds to the **&lt;ListLiveUpdate&gt;** component in React Admin.
