...
title: Application Theme (MIS)
sidebar_label: <ApplicationTheme> (MIS)
description: Application Theme component - Missing implementation
keywords: [application-theme, missing, todo]
---

# Application Theme Component
...
This component corresponds to the **&lt;ApplicationTheme&gt;** component in React Admin.
