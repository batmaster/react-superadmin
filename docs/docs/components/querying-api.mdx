---
id: querying-api
title: Querying Api (MIS)
sidebar_label: <QueryingApi> (MIS)
description: Querying Api component - Missing implementation
keywords: [querying-api, missing, todo]
---

# Querying Api Component
...
This component corresponds to the **&lt;QueryingApi&gt;** component in React Admin.
