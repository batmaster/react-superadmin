---
id: infinite-list
title: Infinite List (MIS)
sidebar_label: <InfiniteList> (MIS)
description: Infinite List component - Missing implementation
keywords: [infinite-list, missing, todo]
---
...
This component corresponds to the **&lt;InfiniteList&gt;** component in React Admin.
