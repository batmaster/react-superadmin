---
id: search
title: Search Component (MIS)
sidebar_label: <Search> (MIS)
description: Search component - Missing implementation
keywords: [search, missing, todo]
---
...
This component corresponds to the **&lt;Search&gt;** component in React Admin.
