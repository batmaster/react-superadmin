...
id: labeled
title: Labeled (MIS)
sidebar_label: <Labeled> (MIS)
description: Labeled component - Missing implementation
keywords: [labeled, missing, todo]
---
...
This component corresponds to the **&lt;Labeled&gt;** component in React Admin.
