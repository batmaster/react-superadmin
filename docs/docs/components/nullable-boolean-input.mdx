---
id: nullable-boolean-input
title: Nullable Boolean Input Component (MIS)
sidebar_label: <NullableBooleanInput> (MIS)
description: Nullable Boolean Input component - Missing implementation
keywords: [nullable-boolean-input, missing, todo]
---

# Nullable Boolean Input Component
...
This component corresponds to the **&lt;NullableBooleanInput&gt;** component in React Admin.
