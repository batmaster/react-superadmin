---
id: authorization
title: Authorization (MIS)
sidebar_label: <Authorization> (MIS)
description: Authorization component - Missing implementation
keywords: [authorization, missing, todo]
---
...
This component corresponds to the **&lt;Authorization&gt;** component in React Admin.
