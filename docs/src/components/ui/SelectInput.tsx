                ...
                {filteredOptions.length === 0 ? (
                  ...
                  filteredOptions.map(option => (
                    <div
                      key={option.value}
                      className={cn(
                        'px-3 py-2 cursor-pointer hover:bg-gray-50 focus:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150',
