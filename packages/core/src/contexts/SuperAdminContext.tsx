...
import { SuperAdminContextValue, AdminConfig, ResourceConfig, ThemeConfig, LayoutConfig, AuthConfig } from '../types';
...
export const SuperAdminProvider: React.FC<SuperAdminProviderProps> = ({ children, config }) => {
  const [user, setUser] = useState<any>(null);
  
  // Convert resources array to object for easier access
  const resources = config.resources.reduce((acc, resource) => {
