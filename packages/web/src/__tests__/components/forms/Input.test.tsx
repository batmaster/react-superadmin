...
describe('Input Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders with different sizes', () => {
      ...
      expect(screen.getByLabelText('Test Input')).toHaveClass('px-2', 'py-1', 'text-sm');

      rerender(<Input {...defaultProps} size="lg" />);
      expect(screen.getByLabelText('Test Input')).toHaveClass('px-4', 'py-3', 'text-lg');
    });
  ...
  describe('Accessibility', () => {
    ...
    it('provides proper ARIA attributes for errors', () => {
      render(<Input {...defaultProps} error="Error message" helperText="Helper text" />);
